...
export const COD_COLLECTION_METHOD = {
  NONE: "NONE",
  CASH: "CASH",
  UPI_QR: "UPI_QR",
};
...
export const LEDGER_TRANSACTION_TYPE = {
  ...
  ORDER_COD_UPI_COLLECTED: "ORDER_COD_UPI_COLLECTED",
...
export const FINANCE_AUDIT_ACTION = {
  ...
  COD_UPI_COLLECTED: "COD_UPI_COLLECTED",
  COD_RECONCILED: "COD_RECONCILED",
...
export const ALL_COD_COLLECTION_METHODS = Object.values(COD_COLLECTION_METHOD);
