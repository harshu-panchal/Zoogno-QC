...
export const getSellerProducts = async (req, res) => {
  try {
    ...
    const [
      ...
      Product.find(query)
        .select(
          "name slug description sku price salePrice stock lowStockAlert gstRate hsnCode upcNumber brand weight mainImage galleryImages headerId categoryId subcategoryId sellerId status approvalStatus approvalRequestedAt approvalReviewedAt approvalReviewedBy approvalNote lastSubmittedByRole isFeatured isReturnable returnWindow variants createdAt",
        )
