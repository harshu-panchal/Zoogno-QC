...
export const updateDeliverySettingsSchema = Joi.object({
  ...
  riderEarningType: Joi.string().valid("fixed", "distance_based").optional(),
  riderFixedAmount: Joi.number().min(0).optional(),
  riderBaseDistance: Joi.number().min(0).optional(),
  riderBaseEarning: Joi.number().min(0).optional(),
  riderExtraPerKm: Joi.number().min(0).optional(),
