    ...
    useEffect(() => {
        ...
        if (db) {
            ...
            let fbTimeout = setTimeout(() => {
                if (mounted) {
                    console.warn("[DeliveryOrderChatModal] Firebase RTDB connection timeout, falling back to REST");
                    fetchChatREST();
                }
            }, 2500);
            ...
            const unsubscribe = onValue(chatRef, (snapshot) => {
                ...
                clearTimeout(fbTimeout);
                console.warn("[DeliveryOrderChatModal] Firebase RTDB read error, falling back to REST:", error);
