...
const BottomNav = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full bg-white/90 backdrop-blur-md border-t border-gray-200/50 pt-2 pb-[max(2rem,calc(env(safe-area-inset-bottom,0px)+8px))] px-6 flex justify-between items-center z-[999] shadow-[0_-4px_20px_-5px_rgba(0,0,0,0.1)]">
