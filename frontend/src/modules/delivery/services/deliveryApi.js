...
export const deliveryApi = {
  ...
  getEarnings: (timeframe, startDate, endDate, isHistory) => axiosInstance.get("/delivery/earnings", { params: { timeframe, startDate, endDate, isHistory } }),
