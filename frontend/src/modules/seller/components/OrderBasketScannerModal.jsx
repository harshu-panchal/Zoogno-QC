...
const OrderBasketScannerModal = ({ isOpen, onClose, onScanSuccess }) => {
    ...
    const handleScan = (data) => {
        ...
        if (trimmed.length < 3) {
            showToast('Invalid QR Code format. Not a recognized Basket ID.', 'error');
            ...
            >
                <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-sm font-black text-slate-900">Scan QR Basket</h3>
...
export default OrderBasketScannerModal;
