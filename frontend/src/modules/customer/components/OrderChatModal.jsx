...
const OrderChatModal = ({ isOpen, onClose, orderId, deliveryBoyName }) => {
    const { token } = useAuth();
    ...
    useEffect(() => {
        ...
        try {
            ...
            console.warn("[OrderChatModal] Firebase RTDB init skipped/failed:", e.message);
        }
                ...
                >
                    ...
                    <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4 bg-gray-50">
                        {isLoading ? (
                            ...
                            <div className="text-center text-xs font-bold text-gray-400 mt-10">Chat with your delivery partner!</div>
                        ) : (
                            messages.map((msg) => (
                                <div key={msg._id} className={`flex ${msg.senderType === "Customer" ? "justify-end" : "justify-start"}`}>
                                    <div className={`max-w-[80%] flex flex-col ${msg.senderType === "Customer" ? "items-end" : "items-start"}`}>
                    ...
                    <div className="bg-white p-3 border-t z-30 relative pb-safe">
                        ...
                        <div className="flex items-center gap-2 bg-gray-100 p-2 rounded-full border border-gray-200">
                            ...
                            <button
                                ...
                                className="p-2.5 rounded-full bg-primary text-primary-foreground disabled:opacity-50 transition-colors shadow-sm"
                            >
