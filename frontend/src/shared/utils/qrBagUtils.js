...
const REQUEST_STATUS_CONFIG = {
    ...
    APPROVED_PAYMENT_PENDING: { label: 'Payment Pending', badge: 'bg-blue-100 text-blue-700' },
    PAYMENT_COMPLETED: { label: 'Paid', badge: 'bg-emerald-100 text-emerald-700' },
    DISPATCHED: { label: 'Dispatched', badge: 'bg-purple-100 text-purple-700' },
